        ...
        child: Obx(() => Stack(
          children: [
            Positioned(
              ...
              child: Text('LOG IN -Ecommerce',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,),textAlign: TextAlign.center),
            ),
            Positioned(
            ...
            Positioned(
                ...
                ElevatedButton(
                  ...
                  controller.setLoginInfo(controller.emailController.text, controller.passwordController.text)
                      .then((value) {
